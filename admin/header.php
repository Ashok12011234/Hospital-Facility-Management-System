...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success" style="background-color: #e3f2fd;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class='nav-item ms-2'><a class='nav-link' href="index.php" id="home_nav">Home</a></li><li class='nav-item ms-2'> <a class='nav-link' href='#'>Hospitals</a></li><li class='nav-item ms-2'><a class='nav-link' href='#'>Providers</a></li><li class='nav-item ms-2'>  <a class='nav-link' href='check_new.php'>Check New</a></li><li class='nav-item ms-2'>    <a class='nav-link' href='./check_change.php'>Check Pending</a></li><li class='nav-item ms-2'>  </li>
            </ul>
        </div>
